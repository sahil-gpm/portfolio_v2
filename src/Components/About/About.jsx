    ...
    return (
        <motion.div ref={ref} id='about'
            ...
            <div className='flex flex-col min-[1200px]:flex-row justify-center text-white mt-10 gap-10'>
                <div className="basic-details text-base flex flex-col justify-center gap-3 md:gap-6">
                ...
                <div className="my-info font-semibold text-xs md:text-base  w-[90%] md:w-[90%] lg:[60%]">
